...
function SalesOrderLines({ lines }) {
  return (
              ...
              {lines.map((line, index) => (
                <tr key={line.id} className="border-b border-slate-100">
                  ...
                  <td className="px-2 py-2">
                    <CellInput value={line.item_code} placeholder="" icon={<Search size={14} />} />
                  </td>
                  <td className="px-2 py-2">
                    <CellInput value={line.description} placeholder="" icon={<Search size={14} />} />
                  </td>
                  <td className="px-2 py-2">
                    <CellInput value={line.unit} placeholder="" />
                  </td>
                  <td className="px-2 py-2">
                    <CellInput value={line.qty} placeholder="" align="right" />
                  </td>
                  <td className="px-2 py-2">
                    <CellInput value={line.rate} placeholder="" align="right" />
                  </td>
                  <td className="px-2 py-2">
                    <CellInput value={line.discount_percent} placeholder="" align="right" />
                  </td>
                  <td className="px-2 py-2">
                    <CellInput value={line.discount_amount} placeholder="" align="right" />
                  </td>
                  <td className="px-2 py-2">
                    <CellInput value={line.net} placeholder="" align="right" />
                  </td>
                  <td className="px-2 py-2">
                    <CellInput value={line.vat} placeholder="" align="right" />
                  </td>
                  <td className="px-2 py-2">
                    <CellInput value={line.net_after_vat} placeholder="" align="right" />
                  </td>
                </tr>
              ))}
            </tbody>
