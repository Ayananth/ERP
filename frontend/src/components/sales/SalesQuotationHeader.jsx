        ...
        <div className="space-y-1">
          <div className="relative">
            ...
            {isEditing ? (
              <select
                ref={registerField(3)}
                className={`w-full appearance-none rounded-lg border border-slate-200 bg-slate-50 px-3 pb-3 pt-5 pr-10 text-sm text-slate-700 transition ${SALES_FOCUS_FIELD}`}
                value={data.customer}
